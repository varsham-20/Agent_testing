...
class Hotel {
    ...
    // Serialization utility methods for persistence
    static void saveStateToFile() {
        try (FileOutputStream fout = new FileOutputStream("backup");
             ObjectOutputStream oos = new ObjectOutputStream(fout)) {
            oos.writeObject(hotel_ob);
        } catch (IOException e) {
            System.err.println("[ERROR] Failed to save hotel state: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    static void loadStateFromFile() {
        ...
        if (f.exists()) {
            try (FileInputStream fin = new FileInputStream(f);
                ...
                System.err.println("[ERROR] Failed to load hotel state: " + e.getMessage());
                e.printStackTrace();
            }
        }
    }
...
public class Main {
    public static void main(String[] args) {
        // Load persisted hotel state on startup
        Hotel.loadStateFromFile();
        ...
        // Defensive: Always attempt to save state on normal exit
        Hotel.saveStateToFile();
    }
}
